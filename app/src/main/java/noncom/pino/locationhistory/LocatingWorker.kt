...
import noncom.pino.locationhistory.database.LocationHistoryDB
import noncom.pino.locationhistory.database.LocationLog
...
class LocatingWorker(private val context: Context, private val workerParams: WorkerParameters): CoroutineWorker(context, workerParams) {
    ...
    private val dao = LocationHistoryDB.getDatabase(applicationContext).dao()
    ...
    override suspend fun doWork(): Result {
        ...
        val listener = OnCompleteListener { task ->
            ...
            if (task.isSuccessful && task.result != null) {
                ...
                val entry = LocationLog(System.currentTimeMillis(), lastLocation.latitude, lastLocation.longitude)
